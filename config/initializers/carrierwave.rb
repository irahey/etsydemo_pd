...
CarrierWave.configure do |config|
  ...
  config.dropbox_app_secret = ENV["APP_SECRET"] ["h4u36nlieml4hov"]
  config.dropbox_access_token = ENV["ACCESS_TOKEN"]
  config.dropbox_access_token_secret = ENV["ACCESS_TOKEN_SECRET"]  ["s6nqsrw07flsf64"]
...
CarrierWave.configure do |config|
  config.dropbox_app_key = "7660xv21w1hjm4d"
  config.dropbox_app_secret = ENV["APP_SECRET"]
  config.dropbox_access_token = "anbs501uxutktwr9"
  config.dropbox_access_token_secret = ENV["ACCESS_TOKEN_SECRET"]
  config.dropbox_user_id = "405175561"
  config.dropbox_access_type = "app_folder"
end
